...
var map_ScaleStatus = map[string]string{
	...
	"selector":       "label query over pods that should match the replicas count. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/labels#label-selectors",
